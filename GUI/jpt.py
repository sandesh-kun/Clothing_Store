...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        for image_path, price in [("shirt.jpg", "1000"), ("shirt.jpg", "1500"), ("shirt.jpg", "2000"), ("shirt.jpg", "2500"), ("shirt.jpg", "3000")]:
            ...
            image_label = QLabel()
            image_label.setPixmap(pixmap.scaledToWidth(150))  # Adjust the width as needed
            ...
            try_on_button.setStyleSheet("width: 100px; text-align: center;")
            buy_button.setStyleSheet("width: 100px; text-align: center;")

            button_layout.addWidget(try_on_button)
